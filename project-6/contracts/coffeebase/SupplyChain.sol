...
contract SupplyChain is RetailerRole, FarmerRole, DistributorRole, ConsumerRole {
  ...
  function harvestItem(uint _upc, address _originFarmerID, string _originFarmName, string _originFarmInformation, string  _originFarmLatitude, string  _originFarmLongitude, string  _productNotes) public 
  {
    ...
    Item memory newItem;
    newItem.consumerID = 0x0000000000000000000000000000000000000000;
    newItem.distributorID = 0x0000000000000000000000000000000000000000;
    ...
    newItem.retailerID = 0x0000000000000000000000000000000000000000;
    newItem.sku = sku;
    newItem.upc = _upc;
